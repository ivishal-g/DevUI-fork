...
/** Detect fenced code blocks like:
 * ```js
 * console.log("hi")
 * ```
 */
...
export default function ChatBox({
  ...
  return (
    <div className="bg-card text-card-foreground flex flex-col rounded-xl border shadow-md w-full max-w-xl mx-auto">
      ...
      {/* Messages */}
      <div ref={scrollRef} className="px-4 pt-3 pb-2 overflow-y-auto max-h-[420px] flex flex-col gap-3" aria-live="polite">
        {messages.map((m) => {
